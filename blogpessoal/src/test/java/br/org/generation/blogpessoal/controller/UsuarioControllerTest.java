...
public class UsuarioControllerTest {
	...
	public void deveRealizarputUsuario() {
		...
		ResponseEntity<Usuario> resposta = testRestTemplate.withBasicAuth("admin@gmail.com", "admin123").exchange("/usuarios/alterar", HttpMethod.PUT, request, Usuario.class);
	    assertEquals(HttpStatus.OK, resposta.getStatusCode());
}
}
